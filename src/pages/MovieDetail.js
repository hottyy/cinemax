...
import Backup from '../assests/Images/backup.jpg';
...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=eb85d31867b5b4b96acf77eaf9884409`);
